...
| ToDo | `collection://2257d017-b6a0-8026-867c-000bb0969507` |
| 選考評価 | `collection://2177d017-b6a0-806a-b025-000b6797112d` |
| セキュリティ人材 (Person DB) | `collection://2cd7d017-b6a0-800a-8333-000b3573c929` |
| CISO DB | `collection://2cd7d017-b6a0-80b9-a3c1-000b7be8e3e5` |
...
### Person DB（セキュリティ人材）
**Collection ID:** `collection://2cd7d017-b6a0-800a-8333-000b3573c929`
**Notion DB ID:** `2cd7d017b6a08044bce2e5b790684a6a`
**URL:** `https://www.notion.so/2cd7d017b6a08044bce2e5b790684a6a`

セキュリティ人材（CISO候補を含む）の基本プロフィールを管理する。

| プロパティ名 | 型 | 説明 |
|---|---|---|
| 名前 | title | 氏名 |
| ポジション名 | text | 現在の肩書（例: CISO, 最高情報セキュリティ責任者） |
| 在籍企業 | relation → 企業DB | 現在の在籍企業 |
| 年齢 | number | - |
| 誕生日 | date | - |
| 入社年月 | date | 現職への入社年月 |
| サマリ | text | 経歴・特徴サマリ |
| salesforce | url | SalesForce レコードURL |
| CISO DB | relation → CISO DB | CISO DBへのリンク |
| 転職DB | relation | 転職DB へのリンク |
| Person ID | auto_increment_id | 自動採番 |

**リレーション:**
- 企業DB → `collection://1fb7d017-b6a0-80b4-a83a-000b901f891a`
- CISO DB → `collection://2cd7d017-b6a0-80b9-a3c1-000b7be8e3e5`

---

### CISO DB
**Collection ID:** `collection://2cd7d017-b6a0-80b9-a3c1-000b7be8e3e5`
**Notion DB ID:** `2cd7d017b6a080e78b7ad14daf145f98`
**URL:** `https://www.notion.so/2cd7d017b6a080e78b7ad14daf145f98`
**親ページ:** セキュリティ案件（`2cb7d017b6a0800b81dcc23cbd5f9d9a`）

日本のIT企業に在籍する現任CISOを管理するDB。`register_ciso.py` スクリプトで自動登録する。

| プロパティ名 | 型 | 説明 |
|---|---|---|
| 名前 | title | CISO 氏名 |
| Person | relation → Person DB | Person DB（セキュリティ人材）へのリンク |
| 在籍企業 | rollup (Person.在籍企業) | 在籍企業名（Person DB から自動取得） |
